...
document.getElementById('submitButton').addEventListener('click', function() {
    ...
    // 숫자 변환 및 기본값 설정
    const stockAmount = isNaN(parseInt(stockAmountValue)) ? 0 : parseInt(stockAmountValue);
    const neededAmount = isNaN(parseInt(neededAmountValue)) ? 0 : parseInt(neededAmountValue);
