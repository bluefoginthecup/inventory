...
document.addEventListener('DOMContentLoaded', function() {
    console.log(document.getElementById('searchTab')); // 요소가 null인지 확인
    console.log(document.getElementById('inputTab'));
    console.log(document.getElementById('allStockTab'));
